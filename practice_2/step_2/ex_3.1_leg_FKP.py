...
""" It is a template of Pranav Bhounsule
    ...
    (1) Changed XML file: have added site
    (2) Set a controller: def pos_controller
    (3) Set a reference of theta1 and theta2: ref
...
ref = [np.pi/6 * np.sin(5e1 * tt) + np.pi/4,
       -np.pi/3 * np.sin(5e1 * tt) - np.pi/2]
